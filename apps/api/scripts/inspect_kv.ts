...
const url = process.env.DATABASE_URL || 'postgresql://neondb_owner:npg_4hHl1AMjTier@ep-quiet-tooth-amze0a44-pooler.c-5.us-east-1.aws.neon.tech/neondb?sslmode=require';
