...
export default function RoomLobbyView() {
  ...
  const games: GameCard[] = [
    { id: 'coinflip', name: 'Coinflip', nameZh: '?œç¡¬å¹?, icon: '?Ÿ¡' },
    { id: 'slots', name: 'Slots', nameZh: '?è?æ©?, icon: '?Ž°' },
    { id: 'roulette', name: 'Roulette', nameZh: 'è¼ªç›¤', icon: '?Ž¡' },
    ...
    { id: 'sicbo', name: 'Sicbo', nameZh: 'éª°å¯¶', icon: '?Ž²' },
    { id: 'bingo', name: 'Bingo', nameZh: 'è³“æ?', icon: '?Ž±' },
    { id: 'crash', name: 'Crash', nameZh: '?´è?', icon: '??' },
    { id: 'duel', name: 'Duel', nameZh: 'å°æ±º', icon: '?”ï?' },
    { id: 'poker', name: 'Poker', nameZh: '?²å?', icon: '??', vipOnly: true },
    { id: 'bluffdice', name: 'Bluff Dice', nameZh: '?¹ç?', icon: '?Ž²', vipOnly: true },
  ];
