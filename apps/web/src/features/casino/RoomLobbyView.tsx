...
export default function RoomLobbyView() {
  ...
  const games: GameCard[] = [
    { id: 'coinflip', name: 'Coinflip', nameZh: '擲硬幣', icon: '🪙' },
    { id: 'slots', name: 'Slots', nameZh: '老虎機', icon: '🎰' },
    { id: 'roulette', name: 'Roulette', nameZh: '輪盤', icon: '🎡' },
    { id: 'blackjack', name: 'Blackjack', nameZh: '21點', icon: '🃏' },
    { id: 'horse', name: 'Horse Racing', nameZh: '賽馬', icon: '🏇' },
    { id: 'dragon', name: 'Shoot Dragon Gate', nameZh: '射龍門', icon: ['🐉', '🎯'] },
    { id: 'sicbo', name: 'Sicbo', nameZh: '骰寶', icon: '🎲' },
    { id: 'bingo', name: 'Bingo', nameZh: '賓果', icon: '🎯' },
    { id: 'crash', name: 'Crash', nameZh: '爆擊', icon: '💥' },
    { id: 'duel', name: 'Duel', nameZh: '對決', icon: '⚔️' },
    { id: 'poker', name: 'Poker', nameZh: '撲克', icon: '♠️', vipOnly: true },
    { id: 'bluffdice', name: 'Bluff Dice', nameZh: '吹牛骰', icon: '🎲', vipOnly: true },
  ];
        ...
        <section className="group relative h-[300px] overflow-hidden rounded-3xl">
          ...
          <div className="absolute bottom-0 left-0 z-20 space-y-4 p-10">
            <div className="flex items-center gap-2">
              <span className="rounded-sm bg-accent px-2 py-1 text-xs font-bold uppercase tracking-widest text-black">
                {t('casino.featured')}
              </span>
                ...
                <div className="flex flex-col items-center space-y-4 text-center">
                  ...
                  {game.vipOnly ? (
                    ...
                    <Link
                      ...
                      className="mt-1 inline-flex items-center gap-2 rounded-lg border border-border/30 bg-[#121212] px-3 py-1.5 text-xs font-bold uppercase tracking-widest text-[#d7d7d7]"
                    >
