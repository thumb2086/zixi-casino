...
export const ITEM_DROP_TABLES: Record<Rarity, ItemDefinition[]> = {
  ...
  mythic: [
    ...
    { id: "title_member_17", name: "神諭等級", nameEn: "Oracle", type: "title", rarity: "mythic", description: "累積押注達 1,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_18", name: "神諭一階", nameEn: "Oracle I", type: "title", rarity: "mythic", description: "累積押注達 2,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_19", name: "神諭二階", nameEn: "Oracle II", type: "title", rarity: "mythic", description: "累積押注達 5,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_20", name: "神諭三階", nameEn: "Oracle III", type: "title", rarity: "mythic", description: "累積押注達 10,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_21", name: "神諭四階", nameEn: "Oracle IV", type: "title", rarity: "mythic", description: "累積押注達 20,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_22", name: "神諭五階", nameEn: "Oracle V", type: "title", rarity: "mythic", description: "累積押注達 50,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_23", name: "神諭六階", nameEn: "Oracle VI", type: "title", rarity: "mythic", description: "累積押注達 100,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_24", name: "神諭七階", nameEn: "Oracle VII", type: "title", rarity: "mythic", description: "累積押注達 200,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_25", name: "神諭八階", nameEn: "Oracle VIII", type: "title", rarity: "mythic", description: "累積押注達 500,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_26", name: "神諭九階", nameEn: "Oracle IX", type: "title", rarity: "mythic", description: "累積押注達 1,000,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_27", name: "神諭十階", nameEn: "Oracle X", type: "title", rarity: "mythic", description: "累積押注達 2,000,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_28", name: "神諭十一階", nameEn: "Oracle XI", type: "title", rarity: "mythic", description: "累積押注達 5,000,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_29", name: "神諭十二階", nameEn: "Oracle XII", type: "title", rarity: "mythic", description: "累積押注達 10,000,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
