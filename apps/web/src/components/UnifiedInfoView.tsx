        ...
        <div className="mx-auto flex max-w-2xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-secondary">綜合指南</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <section className="relative overflow-hidden rounded-2xl border border-accent/20 bg-gradient-to-br from-[#1a1919] to-[#0e0e0e] p-6 shadow-2xl">
          ...
          <div className="relative z-10 mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold uppercase tracking-widest text-secondary">32 個等級 · 專屬特權 · 累積解鎖</p>
            </div>
        ...
        <section className="relative overflow-hidden rounded-2xl border border-purple-400/20 bg-gradient-to-br from-[#1a1919] to-[#0e0e0e] p-6 shadow-2xl">
          ...
          <div className="relative z-10 mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold uppercase tracking-widest text-secondary">頭像 · 稱號 · 5 種稀有度</p>
            </div>
            <div className="ml-auto flex items-center gap-2">
