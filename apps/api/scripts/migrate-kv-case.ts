...
const url = process.env.DATABASE_URL || process.env.POSTGRES_URL || 'postgresql://neondb_owner:REDACTED@ep-quiet-tooth-amze0a44-pooler.c-5.us-east-1.aws.neon.tech/neondb?sslmode=require';
