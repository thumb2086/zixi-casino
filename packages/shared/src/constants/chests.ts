...
export const ITEM_DROP_TABLES: Record<Rarity, ItemDefinition[]> = {
  ...
  legendary: [
    ...
    { id: "title_member_17", name: "永恆等級", nameEn: "Eternal", type: "title", rarity: "mythic", description: "累積押注達 200,000,000,000 子熙幣", icon: "♾️", tradable: false, consumable: false },
    { id: "title_member_18", name: "深淵等級", nameEn: "Abyss", type: "title", rarity: "mythic", description: "累積押注達 500,000,000,000 子熙幣", icon: "🕳️", tradable: false, consumable: false },
    { id: "title_member_19", name: "神諭等級", nameEn: "Oracle", type: "title", rarity: "mythic", description: "累積押注達 1,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_20", name: "神諭一階", nameEn: "Oracle I", type: "title", rarity: "mythic", description: "累積押注達 2,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_21", name: "神諭二階", nameEn: "Oracle II", type: "title", rarity: "mythic", description: "累積押注達 5,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_22", name: "神諭三階", nameEn: "Oracle III", type: "title", rarity: "mythic", description: "累積押注達 10,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_23", name: "神諭四階", nameEn: "Oracle IV", type: "title", rarity: "mythic", description: "累積押注達 20,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_24", name: "神諭五階", nameEn: "Oracle V", type: "title", rarity: "mythic", description: "累積押注達 50,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_25", name: "神諭六階", nameEn: "Oracle VI", type: "title", rarity: "mythic", description: "累積押注達 100,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_26", name: "神諭七階", nameEn: "Oracle VII", type: "title", rarity: "mythic", description: "累積押注達 200,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_27", name: "神諭八階", nameEn: "Oracle VIII", type: "title", rarity: "mythic", description: "累積押注達 500,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_28", name: "神諭九階", nameEn: "Oracle IX", type: "title", rarity: "mythic", description: "累積押注達 1,000,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_29", name: "神諭十階", nameEn: "Oracle X", type: "title", rarity: "mythic", description: "累積押注達 2,000,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_30", name: "神諭十一階", nameEn: "Oracle XI", type: "title", rarity: "mythic", description: "累積押注達 5,000,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_31", name: "神諭十二階", nameEn: "Oracle XII", type: "title", rarity: "mythic", description: "累積押注達 10,000,000,000,000,000 子熙幣", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_32", name: "深淵二階", nameEn: "Abyss II", type: "title", rarity: "mythic", description: "深淵二階", icon: "🕳️", tradable: false, consumable: false },
    { id: "title_member_33", name: "神諭一階", nameEn: "Oracle I", type: "title", rarity: "chaos", description: "神諭一階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_34", name: "神諭二階", nameEn: "Oracle II", type: "title", rarity: "chaos", description: "神諭二階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_35", name: "神諭三階", nameEn: "Oracle III", type: "title", rarity: "chaos", description: "神諭三階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_36", name: "神諭四階", nameEn: "Oracle IV", type: "title", rarity: "chaos", description: "神諭四階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_37", name: "神諭五階", nameEn: "Oracle V", type: "title", rarity: "chaos", description: "神諭五階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_38", name: "神諭六階", nameEn: "Oracle VI", type: "title", rarity: "chaos", description: "神諭六階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_39", name: "神諭七階", nameEn: "Oracle VII", type: "title", rarity: "chaos", description: "神諭七階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_40", name: "神諭八階", nameEn: "Oracle VIII", type: "title", rarity: "chaos", description: "神諭八階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_41", name: "神諭九階", nameEn: "Oracle IX", type: "title", rarity: "chaos", description: "神諭九階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_42", name: "神諭十階", nameEn: "Oracle X", type: "title", rarity: "chaos", description: "神諭十階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_43", name: "神諭十一階", nameEn: "Oracle XI", type: "title", rarity: "chaos", description: "神諭十一階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_44", name: "神諭十二階", nameEn: "Oracle XII", type: "title", rarity: "chaos", description: "神諭十二階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_45", name: "神諭十三階", nameEn: "Oracle XIII", type: "title", rarity: "chaos", description: "神諭十三階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_46", name: "神諭十四階", nameEn: "Oracle XIV", type: "title", rarity: "chaos", description: "神諭十四階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_47", name: "神諭十五階", nameEn: "Oracle XV", type: "title", rarity: "chaos", description: "神諭十五階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_48", name: "神諭十六階", nameEn: "Oracle XVI", type: "title", rarity: "chaos", description: "神諭十六階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_49", name: "神諭十七階", nameEn: "Oracle XVII", type: "title", rarity: "chaos", description: "神諭十七階", icon: "🔮", tradable: false, consumable: false },
    { id: "title_member_50", name: "神話", nameEn: "Myth", type: "title", rarity: "oracle", description: "神話", icon: "🌟", tradable: false, consumable: false },
  ],
  mythic: [
...
export const SPECIAL_ITEMS: ItemDefinition[] = [
  ...
  {
    id: "avatar_crown_supreme",
    name: "至尊皇冠",
    nameEn: "Supreme Crown",
    type: "avatar",
    rarity: "mythic",
    description: "V1.0.10 至尊慶典限定，榮耀之冠",
    icon: "👑",
    tradable: false,
    consumable: false,
  },
  {
    id: "title_founding_elder",
    name: "開國元老",
    nameEn: "Founding Elder",
    type: "title",
    rarity: "mythic",
    description: "V1.0.10 至尊慶典限定，見證歷史的元老",
    icon: "💫",
    tradable: false,
    consumable: false,
  },
