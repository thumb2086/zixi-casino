    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-border/10 bg-gradient-to-br from-[#1a1919] to-[#0e0e0e] p-6 shadow-2xl">
        <div className="flex items-center justify-between mb-3">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.18em] text-secondary">{t('info.my_xp_level')}</p>
      ...
      <section className="rounded-2xl border border-border/10 bg-card p-6 shadow-2xl">
        <h2 className="text-xs font-black uppercase tracking-[0.18em] text-secondary mb-3">{t('info.how_to_earn_xp')}</h2>
      ...
      <section className="rounded-2xl border border-border/10 bg-card p-6 shadow-2xl">
        <h2 className="text-xs font-black uppercase tracking-[0.18em] text-secondary mb-4">{t('info.level_list')}</h2>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <span className={`text-xs font-black w-8 ${isCurrent ? 'text-accent' : 'text-muted'}`}>
                    Lv.{lv}
                  </span>
      ...
      <section className="space-y-3">
        <h2 className="px-2 text-xs font-black uppercase tracking-[0.2em] text-secondary">{t('info.vip_pass')}</h2>
