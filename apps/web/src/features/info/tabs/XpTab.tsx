...
const LEVEL_TIERS: { level: number; xp: string; label: string }[] = [
  { level: 1, xp: '0', label: '普通會員' },
  { level: 5, xp: '300,000', label: '青銅會員' },
  { level: 7, xp: '1,000,000', label: '白銀會員' },
  { level: 10, xp: '8,000,000', label: '黃金會員' },
  { level: 13, xp: '50,000,000', label: '白金會員' },
  { level: 16, xp: '250,000,000', label: '鑽石等級' },
  { level: 19, xp: '900,000,000', label: '黑鑽等級' },
  { level: 21, xp: '2,500,000,000', label: '菁英等級' },
  { level: 23, xp: '6,000,000,000', label: '宗師等級' },
  { level: 25, xp: '15,000,000,000', label: '王者等級' },
  { level: 27, xp: '40,000,000,000', label: '至尊等級' },
  { level: 29, xp: '90,000,000,000', label: '蒼穹等級' },
  { level: 31, xp: '250,000,000,000', label: '寰宇等級' },
  { level: 33, xp: '650,000,000,000', label: '星穹等級' },
  { level: 34, xp: '1 兆', label: '神諭等級' },
  { level: 36, xp: '2.5 兆', label: '神諭一階' },
  { level: 38, xp: '6.5 兆', label: '神諭二階' },
  { level: 40, xp: '16 兆', label: '神諭三階' },
  { level: 42, xp: '40 兆', label: '神諭四階' },
  { level: 44, xp: '100 兆', label: '神諭五階' },
  { level: 46, xp: '250 兆', label: '神諭六階' },
  { level: 48, xp: '650 兆', label: '神諭七階' },
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className={`text-xs font-bold ${isCurrent ? 'text-white' : 'text-[#adaaaa]'}`}>
                    {tier.label}
                  </span>
                </div>
